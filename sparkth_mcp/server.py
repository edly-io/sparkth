...
from .types import CourseGenerationPromptRequest
from .prompt import get_course_generation_prompt
...
async def get_course_generation_prompt_tool(
    ...
    return get_course_generation_prompt(
        course_params.course_name, course_params.course_description
    )
