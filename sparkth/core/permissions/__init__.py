...
The public surface is re-exported from ``sparkth.lib.permissions`` — application code
...
# The role-management permissions gate the role-management API (sparkth/api/v1/permissions).
