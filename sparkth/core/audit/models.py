...
# idempotent; PostgreSQL databases get the triggers from previous migrations, which
# carry their own frozen copies, and a change here needs a new migration. SQLite has
# no TRUNCATE; its truncate optimization is disabled by the presence of a DELETE
