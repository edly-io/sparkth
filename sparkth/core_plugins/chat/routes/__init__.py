...
from sparkth.core_plugins.chat.routes.attachments import router as _attachments_router
from sparkth.core_plugins.chat.routes.completions import (
    router as _completions_router,
)
from sparkth.core_plugins.chat.routes.conversations import (
