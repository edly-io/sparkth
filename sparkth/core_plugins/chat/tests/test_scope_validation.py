...
from sparkth.core_plugins.chat.routes.utils import stream_out_of_scope_refusal
from sparkth.core_plugins.chat.schemas import ChatCompletionResponse, ChatMessage
...
class TestOutOfScopeConversationCreation:
    ...
    async def test_out_of_scope_new_message_creates_no_conversation(
        ...
        with (
            ...
            patch("sparkth.core_plugins.chat.routes.utils.is_query_in_scope", return_value=False),
            patch(
