...
from sparkth.core_plugins.chat.config import get_chat_settings
from sparkth.core_plugins.chat.models import Conversation, Message  # noqa: F401 used in route fixture tests
from sparkth.core_plugins.chat.schemas import (
...
class TestConversationUUIDRoutes:
    ...
    async def test_completions_returns_uuid_conversation_id(
        ...
        with (
            ...
            patch("sparkth.core_plugins.chat.routes.utils.generate_conversation_title"),
            patch(
                "sparkth.core_plugins.chat.service.ChatService.add_message", new_callable=AsyncMock
            ) as mock_add_message,
            patch("sparkth.core_plugins.chat.routes.utils.ScopeClassifier") as mock_classifier_cls,
        ):
