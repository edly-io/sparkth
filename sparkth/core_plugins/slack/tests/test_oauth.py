...
from sparkth.core_plugins.slack.models import SlackWorkspace
from sparkth.core_plugins.slack.oauth import (
    decode_state,
    exchange_code_for_tokens,
    generate_authorization_url,
    generate_state,
)
from sparkth.core_plugins.slack.service import WorkspaceService, decrypt_token, encrypt_token
...
class TestExchangeCodeForTokens:
    ...
    async def test_success_returns_token_data(self) -> None:
        ...
        with patch("sparkth.core_plugins.slack.oauth.httpx.AsyncClient", return_value=mock_http):
