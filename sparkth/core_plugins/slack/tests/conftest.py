...
from sparkth.core_plugins.slack.config import SlackSettings
from sparkth.core_plugins.slack.models import SlackWorkspace
from sparkth.core_plugins.slack.service import encrypt_token
...
def mock_slack_credentials() -> Generator[None, None, None]:
    ...
    with patch(
        "sparkth.core_plugins.slack.routes.oauth.get_slack_credentials",
        return_value=fake,
    ):
        yield
