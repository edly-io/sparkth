...
import sparkth.core_plugins.slack.models  # noqa: F401 — registers tables in SQLModel metadata for Alembic
from sparkth.core_plugins.slack.adapter import SlackConfigAdapter
from sparkth.core_plugins.slack.config import SlackConfig
from sparkth.core_plugins.slack.routes import router
