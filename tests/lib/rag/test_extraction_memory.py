...
class TestExtractionMemory:
    def test_store_shrunk_after_single_batch(self) -> None:
        ...
        with (
            patch("app.lib.rag.extraction.pdf.fitz.open", return_value=_make_mock_doc(3)),
            patch("app.lib.rag.extraction.pdf.fitz.TOOLS") as mock_tools,
    ...
    def test_store_shrunk_once_per_batch(self) -> None:
        ...
        with (
            patch("app.lib.rag.extraction.pdf.fitz.open", return_value=_make_mock_doc(25)),
            patch("app.lib.rag.extraction.pdf.fitz.TOOLS") as mock_tools,
            patch("app.lib.rag.extraction.pdf.pymupdf4llm.to_markdown", return_value="md"),
        ):
    ...
    def test_store_shrunk_even_on_extraction_error(self) -> None:
        ...
        with (
            patch("app.lib.rag.extraction.pdf.fitz.open", return_value=_make_mock_doc(5)),
            patch("app.lib.rag.extraction.pdf.fitz.TOOLS") as mock_tools,
            patch(
