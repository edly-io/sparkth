...
class TestFormatSourceBlock:
    def test_contains_document_context_header(self) -> None:
        result = format_source_block("notes.pdf", [_chunk(content="hello")])
