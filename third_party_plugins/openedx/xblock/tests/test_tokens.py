...
def test_the_token_carries_the_documented_claim_names() -> None:
    token = mint_launch_token("mcq", "placement-1", "course-v1:X+Y+Z", "learner-7", "edit", SECRET, 300)
...
def test_the_token_is_signed_with_hs256() -> None:
    ...
    token = mint_launch_token("mcq", "placement-1", "course-v1:X+Y+Z", "learner-7", "play", SECRET, 300)
