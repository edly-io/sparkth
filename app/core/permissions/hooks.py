from app.lib.hooks import HasName, UniqueCollectionHook
...
PERMISSIONS: UniqueCollectionHook[HasName] = UniqueCollectionHook()
...
PERMISSION_SCOPES: UniqueCollectionHook[HasName] = UniqueCollectionHook()
