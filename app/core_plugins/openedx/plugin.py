...
from app.core_plugins.openedx import tools as openedx_tools
...
class OpenEdxPlugin(SparkthPlugin):
    ...
    def __init__(self, plugin_name: str) -> None:
        ...
        tools_per_category: list[tuple[str, list[Callable[..., Any]]]] = [
            ("openedx-auth", [openedx_tools.openedx_authenticate, openedx_tools.openedx_refresh_access_token]),
            ("openedx-user", [openedx_tools.openedx_get_user_info]),
            (
                "openedx-course",
                [
