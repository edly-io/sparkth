...
Revision ID: 4381dd879570
Revises: 3ae25a31a688
Create Date: 2026-01-30 13:22:58.810851
...
revision: str = "4381dd879570"
down_revision: Union[str, Sequence[str], None] = "3ae25a31a688"
...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_chat_provider_api_keys_is_deleted"), "chat_provider_api_keys", ["is_deleted"], unique=False
    )
    ...
    op.create_index(
        "idx_user_provider_active", "chat_provider_api_keys", ["user_id", "provider", "is_active"], unique=False
    )
