...
def upgrade() -> None:
    ...
    op.create_index(op.f("ix_role_assignment_scope"), "role_assignment", ["scope"], unique=False)
    op.create_index(op.f("ix_role_assignment_scope_object_id"), "role_assignment", ["scope_object_id"], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f("ix_role_assignment_scope_object_id"), table_name="role_assignment")
    op.drop_index(op.f("ix_role_assignment_scope"), table_name="role_assignment")
