...
# embeddings.py
EMBEDDING_BATCH_SIZE = int(os.getenv("RAG_EMBEDDING_BATCH_SIZE", "512"))
DEFAULT_EMBEDDING_PROVIDER = os.getenv("RAG_DEFAULT_EMBEDDING_PROVIDER", "huggingface")
DEFAULT_EMBEDDING_MODEL = os.getenv("RAG_DEFAULT_EMBEDDING_MODEL", "sentence-transformers/all-MiniLM-L6-v2")
DEFAULT_EMBEDDING_DIMENSIONS = int(os.getenv("RAG_DEFAULT_EMBEDDING_DIMENSIONS", "384"))
